            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Fill the details for <?php
                                if(!strcmp($form, "03")){
                                    echo "Semester Progress Report";
                                }
                                else if(!strcmp($form, "09")){
                                    echo "Report of Examiners of Comprehensive Examination";
                                }
                                else if(!strcmp($form, "10")){
                                    echo "Report of Examiners of the State of the Art Seminar";
                                }
                                else if(!strcmp($form, "11")){
                                    echo "Report of Open Seminar";
                                }
                                ?></h4>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    <td>
                                                        <a href="./fillReport<?php echo $form ?>.php?student_reg_no=<?php echo $thisStudent['reg_no'] ?>">
