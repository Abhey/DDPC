<?php
	...
	$meeting_no=$_GET['m_no'];
   // $s_query = "SELECT meeting_no from `meeting` WHERE meeting_no = '$supervisor_id'";
    //$s_result = mysqli_query($connection, $s_query);
   // $s_array = array();
    //while($s_row = mysqli_fetch_array($s_result))
   // {
       // array_push($s_array, $s_row['meeting_no']);
   // }
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
									     ...
									     <tr>
										 <td><?php echo $meeting_no;?></td>
										  </tr>
                                          <?php /* $query = "SELECT * FROM `leave`";
