...
$s_query = "Select * from currentsupervisor WHERE supervisor1_id = '$hod_id'";
                                ...
                                <div class="row">
                                        <div class="col-md-12">
                                                <div class="card">
                                                        ...
                                                        <form class="form form-horizontal" id="stipend" action="submitHODStipend.php" method="post">
                                                                <div class="row">
                                                ...
                                                <!----------------------------------To Be Filled by HOD ----------------------------->
                                                                ...
                                                                $medlLeaveQuery = "SELECT month(from_date) \"Month\",sum(`no_of_days`) \"Total Days\" from `leave` where `reg_no`='$thisUniqueID' and `sem_no` = ".$stipendResult['sem']." and `academic_year`=". $stipendResult['year']." and `leave_type` = 1 and `status`='approved' having Month = '".$stipendResult['month']."'";
