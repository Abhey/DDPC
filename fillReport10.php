	<?php
		...
		$result = mysqli_query($connection, $query);
		$studentthesisdetails = mysqli_fetch_assoc($result);
		if($studentprg['date_of_soa'] == 0 || strtotime($studentprg['date_of_soa'] > time())){
			echo "<script>
			alert('The State-of-the-Art Seminar of this student has not taken place yet.');
							...
							<b>
								...
								<div class="col-md-offset-1" style="font-size:15px">
									...
									<div class="col-md-11">
											...
											<?php
												if($studentprg['date_of_comp'] == 0){
											?>
												<input type="text" id="comp_date" name="comp_date">
											<?php
												}
												else {
													echo $studentprg['date_of_comp'];
											?>
												<input type="text" id="comp_date" name="comp_date" value="<?php echo $studentprg['date_of_comp']?>" hidden>
											<?php
												}
											?>
									...
									<div class="col-md-11">
											...
											?>
												<input type="text" id="sem_date" name="sem_date" value="<?php echo $studentprgdetails['date_of_open']?>" hidden>
											<?php
													echo $studentprgdetails['date_of_open'];
												}
											?>
									</div>
									<div class="col-md-11">
